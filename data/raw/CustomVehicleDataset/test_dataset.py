...
def quick_validate_xml_data():
    ...
    xml_files = {
        r'C:\IT\re-identification\basement\data\raw\CustomVehicleDataset\annotations_11.xml': 1,  # Camera 1
        r'C:\IT\re-identification\basement\data\raw\CustomVehicleDataset\annotations_21.xml': 2,  # Camera 2
    }
        ...
        for image in root.findall('image'):
            ...
            for box in image.findall('box'):
                ...
                if id_attr is not None:
                    ...
                    print(f" Empty ID found in camera {camera_id}, frame {frame_id}")
    ...
    if total_unique_vehicles > 5:
        ...
        print("  Limited vehicle diversity - may affect model performance")
